...
<main>
    <div class="container mt-5 mb-4">
        <h1 class="font-weight-bold text-center">LATIHAN 3</h1>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>
                            <?php if ($_POST['nilai'] >= 80): ?>
                                Kamu mendapatkan nilai A!
                            <?php elseif ($_POST['nilai'] >= 60): ?>
                                Kamu mendapatkan nilai B!
                            <?php elseif ($_POST['nilai'] >= 40): ?>
                                Kamu mendapatkan nilai C!
                            <?php elseif ($_POST['nilai'] >= 20): ?>
