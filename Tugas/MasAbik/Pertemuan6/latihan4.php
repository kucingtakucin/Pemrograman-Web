...
<main>
    <div class="container mt-5 mb-4">
        <h1 class="font-weight-bold text-center">LATIHAN 4</h1>
        <form action="" method="post">
            <div class="row">
                <div class="form-group col-md-4 offset-4">
                    <label for="ranking">Ranking</label>
                    <input type="text" name="ranking" class="form-control" id="ranking" required>
                </div>
            </div>
            <div class="row">
                <div class="form-group col-md-4 offset-4">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Hasil Pemeringkatan</h5>
